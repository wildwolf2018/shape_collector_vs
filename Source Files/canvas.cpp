...
{
	ResourceManager::LoadShader("Shaders\\vertex_shader.txt", "Shaders\\frag_shader.txt", "wallShader");
	ResourceManager::LoadShader("Shaders\\vert_skybox.txt", "Shaders\\frag_skybox.txt", "skyboxShader");
	ResourceManager::LoadShader("Shaders\\vertexFloorShader.txt", "Shaders\\fragFloorShader.txt", "floorShader");
	ResourceManager::LoadTexture("Textures\\bricks_diff.jpg", false, "frontWall");
	ResourceManager::LoadTexture("Textures\\marble_ceiling.jpg", false, "floor");
	ResourceManager::LoadTexture("Textures\\brick.jpg", false, "sideWalls");
	initialise();
