...
Shadow::Shadow()
{
	ResourceManager::LoadShader("Shaders\\model_vshader.txt", "Shaders\\model_fshader.txt", "model");
	ResourceManager::LoadShader("Shaders\\shadow_vertex_shader.txt", "Shaders\\shadow_fragment_shader.txt", "shadow_map");
